...
def cluster_assembly(clustering_jar_file: str, clustering_properties_file: str, memory: int) -> None:
...
def main():
    ...
    cluster_assembly(args.clustering_jar_file, args.clustering_properties_file, args.memory)
